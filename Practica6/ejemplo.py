...
rp  = RedPitayaApp('http://rp-XXXXXX.local/lock_in+pid_harmonic_hf/?type=run', name='rp')


########################################################################
#                                                                      #
# No se olviden de copiar y pegar el URL de SU APP ...                 #
# No es lo mismo la versión "Harmonic" que la versión "Harmonic HF"    #
#                                                                      #
########################################################################
